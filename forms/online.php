    ...
    <div class="panel">
        <form role="form" id="contact-form" class="contact-form" method="post" action="#">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" class="form-control" name="link" id="link" placeholder="Линк към сайта">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" class="form-control" name="service" id="service" placeholder="Услуга">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <input type="submit" class="btn main-btn pull-right" value="Сигнализирай" name="online_send">
                </div>
            </div>
        </form>
    </div>
